...
class DeckPage extends Component {
  ...
  render() {
    const { deck: propsDeck, actions = BASE_ACTIONS, navigation } = this.props;

    const deck =
      propsDeck ||
      navigation.getParam(
        'deck',
        this.props.screenProps.deck || { cards: {}, name: 'None', id: -1 }
      );
    const refreshDeckList = navigation.getParam('refreshDeckList', () =>
      console.log('refreshDeckList is null')
    );
    console.log(
      'Rendering deck page',
      deck,
              ...
              <Fragment key={`fragment-${index}`}>
                <ButtonBase
                  ...
                  onClick={() =>
                    navigation &&
                    action.toStack &&
                    navigation.navigate(action.toStack, {
                      ...this.props,
                      deck,
                      refreshDeckList,
                      from: 'DeckPage',
